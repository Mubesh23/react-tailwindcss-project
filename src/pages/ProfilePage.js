...
import profilePic from '../static-assests/images/profilePic.jpg'
      ...
      <div className="h-screen flex flex-col justify-center items-center">
        <div className="h-1/2 flex flex-row w-full bg-gray-200 rounded-t-md mb-2 shadow-lg p-8">
          ...
          <div className="flex flex-col items-center justify-center w-2/3">
            ...
            <textarea className="w-full h-64 border rounded-lg p-2 text-gray-700" placeholder="Write something about yourself..." />
          </div>
        </div>
